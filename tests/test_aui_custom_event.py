...
class TestCustomEventCreation:
    ...
    def test_basic_creation(self):
        ...
        event = CustomEvent(
            name="learning_milestone", value={"milestone": "first_story_completed"}
        )
    ...
    def test_with_null_value(self):
        ...
        event = CustomEvent(name="session_started")
...
class TestCustomEventSerialization:
    ...
    def test_serialization(self):
        ...
        event = CustomEvent(name="progress_update", value={"percent": 50})
    ...
    def test_json_string_serialization(self):
        ...
        event = CustomEvent(name="test", value={"key": "value"})
