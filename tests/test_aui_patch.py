...
def test_create_state_diff_nested():
    old = {"component": "Card", "props": {"title": "Hello", "items": ["a", "b"]}}
    new = {
        "component": "Card",
        "props": {
            "title": "Hello",
...
def test_vocabulary_flip_scenario():
    ...
    old_doc = {
        ...
        "props": {"words": ["hello", "world"], "current_index": 0, "is_flipped": False},
...
def test_progressive_card_expansion():
    ...
    base_state = {
        "component": "VocabGrid",
        "props": {"words": ["one", "two", "three"], "expanded_indices": []},
    }
...
def test_patch_application_correctness():
    ...
    old_state = {"count": 0, "status": "idle", "metadata": {"version": 1}}
    new_state = {
        "count": 5,
        "status": "running",
