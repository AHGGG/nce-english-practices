...
def chunk_pcm_audio(pcm_data: bytes, chunk_size: int = 3200) -> Generator[bytes, None, None]:
    """
...
async def stream_pcm_chunks(pcm_data: bytes, chunk_size: int = 3200, interval_ms: int = 100) -> AsyncGenerator[bytes, None]:
    """
...
def extract_keywords(text: str) -> set:
    ...
    """
    import re
    stop_words = {'a', 'an', 'the', 'is', 'are', 'was', 'were', 'this', 'that', 'it', 'to', 'of', 'and', 'or'}
