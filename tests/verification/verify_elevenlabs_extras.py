...
async def verify_elevenlabs_extras():
    ...
    try:
        sfx_chunks = []
        async for chunk in provider.text_to_sfx("Cinematic boom sound effect", duration_seconds=2.0):
    ...
    try:
        tts_chunks = []
        async for chunk in provider.tts("This is the original voice.", "21m00Tcm4TlvDq8ikWAM", "eleven_turbo_v2_5"):
