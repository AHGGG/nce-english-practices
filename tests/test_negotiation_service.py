...
from app.models.negotiation_schemas import NegotiationRequest, UserIntention, NegotiationContext, NegotiationStep
from app.services.llm import llm_service

@pytest.mark.asyncio
async def test_negotiation_flow():
    # Mock LLM
    llm_service.chat_complete = AsyncMock(side_effect=[
    ...
    context = NegotiationContext(
        target_content="The ubiquity of smartphones.",
        source_type="test"
    )
    ...
    req1 = NegotiationRequest(
        ...
        user_intention=UserIntention.HUH,
        context=context
    )
