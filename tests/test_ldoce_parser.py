...
class TestLDOCEParser:
    ...
    def test_parse_simmer_senses(self):
        ...
        assert "boil" in sense1.definition.lower() or "cook" in sense1.definition.lower()
    ...
    def test_parse_simmer_grammar(self):
        ...
        assert "intransitive" in sense1.grammar.lower() or "transitive" in sense1.grammar.lower()
...
class TestLDOCEParserExtendedData:
    ...
    def test_simmer_thesaurus(self):
        ...
        if verb_entry.thesaurus:
            ...
            if thes.entries:
                ...
                assert any(w in words for w in ["boil", "fry", "bake", "cook", "steam", "roast"])
    ...
    def test_noun_entry_no_verb_table(self):
        ...
        # Find noun entry
        noun_entry = next((e for e in result.entries if e.part_of_speech == "noun"), None)
        if noun_entry:
