...
def upgrade() -> None:
    ...
    op.create_index('idx_progress_user_topic', 'user_progress', ['user_id', 'topic'], unique=False)
    ...
    op.create_index(op.f('ix_srs_schedule_next_review_at'), 'srs_schedule', ['next_review_at'], unique=False)
    op.create_index('idx_story_topic_tense', 'stories', ['topic', 'target_tense'], unique=False)
