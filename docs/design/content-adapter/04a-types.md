...
## 2. Audio-specific Types (Phase 2)

```typescript
// apps/web/src/components/content/types.ts (continued)
...
## 3. Comic-specific Types (Phase 3)
...
## 4. Shared Block Props

```typescript
// apps/web/src/components/content/shared/types.ts
...
_Next: [04b-registry.md](./04b-registry.md) - Registry 实现_
