...
- [x] **Ingestion Strategy**: Content-driven learning from external sources.
  ...
  - [x] **EPUB Image Support** (2025-12-29):
    ...
    - [x] `/api/content/asset` endpoint for serving provider assets.
...
_(Note: This 4-stage model is being deprecated in favor of the unified voice flow)_
_For beginners or starting a new concept._
...
- [ ] **Interactive Explainer**:
  - Click any sentence in the story to see a breakdown: "Why was _had been running_ used here?"
  - **Tech**: LLM analysis on demand.

## 2. Stage 1: The Matrix Gym (The "Drill" Stage)

_For building speed and mechanical accuracy._
...
_For checking understanding in isolation._

- [ ] **Smart Cloze Mode**:
  - The system hides the _critical_ grammar components (auxiliary verbs, participial endings) based on the target tense.
  - _Not just random words_, but structurally relevant deletions.
- [ ] **Sentence Scramble**:
  - Reassemble complex sentences to internalize word order (syntax).

## 4. Stage 3: Real-World Simulation (The "Speak" Stage)

_The ultimate goal: Spontaneous usage._

- [x] **Scenario Roleplay**:
  - "You are at a cafe. Order a coffee using _would like_."
  - Open-ended chat interface with an AI persona.
- [ ] **Mission System**:
  - The AI judges if you _achieved the goal_ AND _used the grammar correctly_.
- [x] **Grammar Coach** (New):
...
_Features that support the learning journey._
  ...
  - [x] **Sentence Study Mode (ASL)** (2026-01-01):
    ...
    - [x] **UX Enhancements** (2026-01-02):
      ...
      - [x] **Book Shelf Navigation** (2026-01-02):
        ...
        - [x] **Library API**: `/api/content/catalog/{source_type}` endpoint.
    ...
    - [x] **UX Optimizations** (2026-01-03):
      ...
      - [x] **Reading-SentenceStudy Integration** (2026-01-04):
        ...
        - [x] **Unified Unit Status API**: `/api/content/units/{source_type}/{item_id}/with-status` with combined progress.
...
_Goal: Combine Synthwave aesthetics with Ink & Paper sharpness for a high-performance "Mental Gym"._
