...
if os.path.exists(frontend_dist):
    ...
    async def serve_spa(full_path: str):
        ...
        # Determine the potential file path
        requested_path = os.path.abspath(os.path.join(safe_base, full_path))

        # Check if the requested path is within the safe base directory
        if os.path.commonpath([safe_base, requested_path]) != safe_base:
            # Traversal attempt, fallback to index
