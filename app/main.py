...
if os.path.exists(frontend_dist):
    ...
    async def serve_spa(full_path: str):
        ...
        # Check if resolved path is within frontend_dist
        # commonpath ensures file_path starts with base_path
        try:
            if os.path.commonpath([base_path, file_path]) != base_path:
                # Path traversal attempt or outside directory - fallback to index
