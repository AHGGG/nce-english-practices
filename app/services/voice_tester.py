...
from app.services.voice_lab import voice_lab_service, VoiceProvider
...
class VoiceTester:
    ...
    async def evaluate_tts(self, 
                           tts_provider_name: str, 
                           tts_model: str, 
                           text: str,
                           voice_id: str = None,
                           stt_judge_name: str = "deepgram",
                           stt_judge_model: str = "nova-3") -> TestResult:
        """
        ...
        try:
            ...
            if len(full_audio) == 0:
                return TestResult(False, 0.0, (time.time() - start_time) * 1000, "", text, "No audio generated")
            ...
            return TestResult(False, 0.0, (time.time() - start_time) * 1000, "", text, str(e))
    ...
    async def evaluate_stt(self, 
                           ...
                           tts_ref_model: str = "eleven_turbo_v2") -> TestResult:
        """
    ...
    async def evaluate_sts(self,
                           sts_provider_name: str,
                           voice_id: str, # Target voice
                           text: str,
                           tts_ref_name: str = "elevenlabs",
                           stt_judge_name: str = "deepgram") -> TestResult:
        """
        ...
        try:
            ...
            async for chunk in tts_ref.tts(text, "21m00Tcm4TlvDq8ikWAM", "eleven_turbo_v2_5"):
            ...
            if len(target_audio) == 0:
                 return TestResult(False, 0.0, (time.time() - start_time) * 1000, "", text, "No STS audio generated")
