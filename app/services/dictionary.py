...
class DictionaryManager:
    ...
    def load_dictionaries(self):
        ...
        if db_files:
            ...
            print("No SQLite databases found. Run: uv run python scripts/convert_mdx_to_sqlite.py")
        ...
        for mdx_path in mdx_files:
            try:
                ...
                if not loaded_from_cache:
                    ...
                    print(f"Loaded {len(mdx_cache)} entries in {time.time() - start_time:.2f}s")
    ...
    def _lookup_sqlite(self, word: str, word_lower: str, conn: sqlite3.Connection) -> Optional[bytes]:
