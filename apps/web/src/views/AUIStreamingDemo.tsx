  ...
  const demos: DemoConfig[] = [
    {
      ...
      getUrl: () =>
        `/api/aui/stream/contexts?book=${selectedBook}&user_level=1`,
    },
    {
      id: "story",
      label: "Story Stream",
      ...
      getUrl: () =>
        "/api/aui/stream/story?content=" +
        encodeURIComponent(
          "Once upon a time, in a small village, there lived a curious young girl named Emma. She loved exploring the nearby forest.",
        ) +
        "&title=Test Story&user_level=1&chunk_size=3",
    },
    {
      id: "vocab",
      label: "Vocabulary",
      ...
      getUrl: () =>
        "/api/aui/stream/vocabulary?words=explore,discover,mysterious,treasure,curious&user_level=1",
    },
    {
      id: "state-sync",
      label: "State Sync",
    ...
    },
    {
      ...
      getUrl: () =>
        "/api/aui/demo/stream/state-snapshot?title=Demo%20Story&level=1",
    },
    {
      id: "activity",
      ...
      getUrl: () =>
        "/api/aui/demo/stream/activity?task=Test%20Data%20Processing&steps=5",
    },
    {
      id: "tool-call",
      label: "Tool Call",
      ...
      getUrl: () =>
        "/api/aui/demo/stream/tool-call?tool=search_vocabulary&query=example",
    },
    {
      id: "agent-success",
      label: "Agent Run ✅",
      ...
      getUrl: () =>
        "/api/aui/demo/stream/agent-run?task=Generate%20Test%20Story&fail=false",
    },
    {
      id: "agent-error",
      label: "Agent Run ❌",
      ...
      getUrl: () =>
        "/api/aui/demo/stream/agent-run?task=Generate%20Test%20Story&fail=true",
    },
    {
      id: "multi-messages",
    ...
    },
    {
      ...
      getUrl: () =>
        "/api/aui/demo/stream/interrupt?reason=confirmation_required&difficulty=intermediate",
    },
    {
      id: "contexts",
      ...
      <div className="w-full md:w-1/3 space-y-6">
        <header className="mb-4 md:mb-8 border-b border-border pb-4">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl md:text-2xl font-serif font-bold text-text-primary">
              AUI Streaming Demo
            </h1>
          </div>
          <p className="text-xs text-text-muted mt-2">
            Event Streaming Testbed with Transport Selection
          </p>
        </header>
        ...
        {/* Demo Selection Grid */}
        <div>
          <label className="block text-xs uppercase text-text-muted mb-3">
            Select Demo
          </label>
          <div className="grid grid-cols-2 gap-2">
            {demos.map((demo) => (
              <button
                ...
                className={`p-4 md:p-3 text-left rounded border transition-all active:scale-95 ${
              ...
              >
                ...
                <div className="text-[10px] opacity-60 mt-1 hidden md:block">
                  {demo.description}
                </div>
              </button>
            ))}
          ...
          <div className="min-h-full w-full p-4 md:p-8 flex items-center justify-center">
            {streamUrl ? (
              ...
              <div className="text-border text-center">
                <p className="text-4xl opacity-20 font-serif">
                  AWAITING SIGNAL
                </p>
                <p className="text-xs opacity-10 mt-4">
                  Select a demo to start streaming
                </p>
              </div>
            )}
          </div>
