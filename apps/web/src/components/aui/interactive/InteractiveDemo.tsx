...
type DemoVariant = "primary" | "danger";

interface InteractiveOption {
  label: string;
  action: string;
  variant?: DemoVariant | "destructive";
}
...
const InteractiveDemo = ({
  ...
  // Status config map
  const config: Record<DemoStatus, StatusConfig> = {
    processing: {
  ...
  return (
    <Card
      className={`w-full max-w-md mx-auto transition-all duration-300 ${currentConfig.color}`}
    >
