    ...
    const processAudioQueue = async () => {
        ...
        try {
            ...
            while (audioQueueRef.current.length > 0) {
                ...
                const rawData = new Int16Array(chunk.buffer, chunk.byteOffset, chunk.byteLength / 2);
        ...
        try {
            ...
            ws.onmessage = async (event) => {
                if (typeof event.data === 'string') {
                    ...
                    if (data.byteLength > 44 && view.getUint32(0) === 0x52494646) { // RIFF
                        data = data.slice(44);
                    }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-6">
                    <div className="p-4 bg-bg-elevated rounded border border-border">
                        ...
                        {connectionState !== 'connected' ? (
                            <Button fullWidth onClick={connectWebSocket} isLoading={connectionState === 'connecting'}>
                                Connect Server
                            </Button>
                        ) : (
            ...
            <Card title="Streaming Input">
                <div className="flex flex-col h-full space-y-4">
                    <Textarea
                        label="Input Text"
                        inputClassName="font-serif text-lg min-h-[150px] resize-none"
                        value={textInput}
