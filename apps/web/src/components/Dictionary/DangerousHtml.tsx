...
interface DangerousHtmlProps extends IframeHTMLAttributes<HTMLIFrameElement> {
  html: string;
  className?: string;
}
    ...
    const handleMessage = (event: MessageEvent) => {
      ...
      if (
        ...
        if (
          ...
          "type" in event.data &&
          (event.data as { type?: string }).type === "resize"
        ) {
          const newHeight = (event.data as { height?: number }).height;
