...
const Layout = () => {
    return (
        <div className="flex h-screen w-full relative overflow-hidden bg-[#0f172a] text-white font-sans antialiased selection:bg-sky-400 selection:text-white">
            {/* Mobile Header */}
            <header className="md:hidden absolute top-0 left-0 right-0 z-50 flex items-center gap-3 px-4 py-3 bg-[#0f172a] border-b border-white/10 h-[64px]">
            ...
            <main className="flex-1 flex flex-col h-full overflow-hidden relative md:pt-0 pt-[64px]">
                <Outlet />
            </main>
