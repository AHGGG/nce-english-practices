                            ...
                            <div className="space-y-3">
                                {quizData.options.map(opt => (
                                    <div
                                        ...
                                        className={`w-full text-left p-4 rounded-xl border flex items-center gap-3 transition-colors group cursor-pointer
                                    ${answered
                                                ? opt.is_correct
                                                    ? 'bg-emerald-500/20 border-emerald-500/50'
                                                    : 'bg-slate-700/50 border-white/5 opacity-60' // non-selected logic needs care
                                ...
                                `}
                                    // Simplified answered logic for styling. 
                                    // Better logic: if answered, show correct green, if I picked wrong show mine red.
                                    >
